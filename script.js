...
(function () {
    ...
    if (leadForm) {
        leadForm.addEventListener('submit', function (e) {
            ...
            var lang = localStorage.getItem('ael-lang') || 'ar';
            var msg;
            if (lang === 'fr') {
            ...
            var url = 'https://wa.me/212643907269?text=' + encodeURIComponent(msg);
    ...
    function updateWhatsAppLinks() {
        ...
        document.querySelectorAll('a[href*="wa.me/212643907269?text="]').forEach(function(link) {
            link.href = 'https://wa.me/212643907269?text=' + encodeURIComponent(msg);
        });
    }
    updateWhatsAppLinks();
    ...
    if (bubble) {
        ...
        try { bubbleDismissed = sessionStorage.getItem('ael-wa-bubble') === '1'; } catch (e) {}
        if (!bubbleDismissed) {
            setTimeout(function () {
        ...
        if (bubbleClose) {
            bubbleClose.addEventListener('click', function (e) {
                ...
                try { sessionStorage.setItem('ael-wa-bubble', '1'); } catch (e) {}
            });
        }
    }
